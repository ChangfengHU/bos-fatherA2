	...
	$(function(){
		$("input[name='checkcode']").blur(function(){
			...
			$.post("${pageContext.request.contextPath}/userAction_validCheckCode",{"checkcode":this.value},function(data){
				if(data){
					//  用户span提示  
					$("#checkcode_sp").html("<font  size='6' color='red'>√</font>");
					checkcode_flag = true;
				}else{
					// span  验证码错误
					$("#checkcode_sp").html("<font size='6' color='red'>x</font>");
					checkcode_flag = false;
				}
			});
		});
		...
		<div id="loginBlock" class="login"
			...
			<s:fielderror></s:fielderror>
				<form id="loginform" name="loginform" method="post" class="niceform"
					...
					<div>
					  <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<a href="smspassword.jsp" target="_blank">短信找回密码?</a> <span id="checkcode_sp"></span>
						&nbsp;&nbsp;<font color="red"></font>
					</div>

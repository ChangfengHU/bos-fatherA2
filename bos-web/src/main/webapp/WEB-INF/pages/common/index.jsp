...
<script
	...
	$(function() {
		...
		$("#btnEp").click(function(){
			...
			//  如果密码合法   更新数据库
			$.post("${pageContext.request.contextPath}/userAction_gobackpassword1",
					{"password":$("input[name='password']").val()}
					,function(data){
						if(data){
							$.messager.alert("恭喜!","密码已经aaa修改!","info");
							location.href="${pageContext.request.contextPath}/login.jsp";
						}else{
							$.messager.alert("可惜!","密码修改失1败","error");
						}
					});
		});
	});
        ...
        <div class="easyui-layout" fit="true">
            <div region="center" border="false" style="padding: 10px; background: #fff; border: 1px solid #ccc;">
                <table cellpadding=3>
                    <tr>
                        <td>新密码：</td>
                        <td><input name ="password" id="txtNewPass" type="Password" class="txt01" /></td>
                    </tr>
                    <tr>
                        <td>确认密码：</td>
            ...
            <div region="south" border="false" style="text-align: right; height: 30px; line-height: 30px;">
                <a id="btnEp" class="easyui-linkbutton" icon="icon-ok" href="javascript:void(0)" >确定1</a>

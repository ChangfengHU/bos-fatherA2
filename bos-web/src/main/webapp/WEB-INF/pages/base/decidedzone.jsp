    ...
    <script type="text/javascript">
        ...
        function doDblClickRow() {
            ...
            $('#association_subarea').datagrid({
                ...
                rownumbers: true,
                striped: true,
                url: "${pageContext.request.contextPath }/subareaAction_queryAll?deid="+deid,
                columns: [[{
                    field: 'subid',
                    title: '分拣编号',
                    width: 120,
            ...
            $('#association_customer').datagrid({
                ...
                rownumbers: true,
                striped: true,
                url: "${pageContext.request.contextPath }/decidedZoneAction_findassociationcustomers1?id="+deid,
                columns: [[{
                    field: 'id',
                    title: '客户编号',
                    width: 120,

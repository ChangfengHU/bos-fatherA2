			...
			<form id="addDecidedZoneForm" action="${pageContext.request.contextPath }/decidedZoneAction_save" method="post">
				<table class="table-edit" width="80%" align="center">
					...
					<tr height="300">
						...
						<td>
							<table id="subareaGrid"  class="easyui-datagrid" border="false" style="width:300px;height:300px" data-options="url:'${pageContext.request.contextPath }/subareaAction_noassociation',fitColumns:true,singleSelect:false">
								<thead>  
							        <tr>  
							            <th data-options="field:'subid',width:30,checkbox:true">编号</th>
